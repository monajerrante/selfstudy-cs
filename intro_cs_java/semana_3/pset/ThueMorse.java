...
public class ThueMorse {
    public static void main( String[] argv ){
        ...
        char[][] matrice = new char[size][size]; // Crea la matriz
        
        char[] line = new char[size]; // Crea la cadena horizontal y vertical
        line[0] = '+';                // con el primer elemento puesto a cero 
        
        matrice[0][0] = '+'; // No hace falta pero ¿porque no?
